  ...
  return (
    <div className="relative">
      ...
      <Dropdown
        ...
        className="absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border border-gray-300 bg-white p-3 shadow-theme-lg dark:border-stone-700 dark:bg-stone-800"
      >
        <div>
        ...
        <Button
          ...
          icon={<svg
            className="fill-white group-hover:fill-white dark:group-hover:fill-white"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            fill="none"
